...
import { Send, User, Bot, Github, ExternalLink } from 'lucide-react';
...
const ProfileSection: React.FC<Props> = ({ profile_image_url, about, name = "Ch.Varun", linkedin, children: _children }) => {
  if (!linkedin) {
    linkedin = "";
  }
  ...
  const buildSystemPrompt = (userName: string, linkedinData: string) => {
    return `You are acting as ${userName}. You are answering questions on ${userName}'s website, related to their experience, skills, and career. Be friendly, professional, and helpful. Here's their LinkedIn for context:\n${linkedinData}. Make sure to answer in 1-2 lines for every question.`;
  };
  ...
  return (
    <div id="home">
      <ScrollExpandMedia
        mediaType="image"
        mediaSrc="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1280&q=80"
      ...
      >
        {/* Profile Content - revealed after scroll expansion */}
